				...
				<div class="sa-content no-padding">
					...
					<div class="d-flex w-100">
						<section id="widget-grid" class="w-100">
                            ...
                            <div class="text-center fadeIn animated" style="margin-top:15rem;">
                                <!-- <code>Login Error :(</code><br><br> -->
                                <h1 class="error-text font-weight-bold text-primary"> <img class="img-reponsive" src="../images/logo.png" style="width: 20rem"></h1>
                                <br><br><h4 class="font-weight-bold m-0">플레이 스토어에서 코코팜 검색 후</h4><p><h4 class="font-weight-bold m-0">최신버전으로 업데이트 바랍니다.</h4></p>
                            </div>
