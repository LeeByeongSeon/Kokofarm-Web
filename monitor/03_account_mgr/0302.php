	...
	function get_grid_data(){
		$("#jqgrid").jqGrid({
			...
			colModel: [
				...
				{label: "위도",		name: "fdGpslat",	align:'center',		editable:true, hidden:true, editrules:{ required: true, edithidden: true} },
				{label: "경도",		name: "fdGpslng",	align:'center',		editable:true, hidden:true, editrules:{ required: true, edithidden: true} },
